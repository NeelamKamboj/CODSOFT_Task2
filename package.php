...
<div class="heading" style="background:url(images/survey.jpg) no-repeat">
   <h1>galleries</h1>
</div>
...
<section class="packages">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <div class="image">
            <img src="images/recommendation/Rishikesh.jpg" alt="">
         </div>
         <div class="content">
            <h3>Rishikesh Tour Packages</h3>
            <p>Enjoy the Emirates with unforgettable fun with our china top selling packages!</p>
            <h2>BDT 5,900</h2>
            <a href="book.php" class="btn">book now</a>
         </div>
      ...
      <div class="box">
         <div class="image">
            <img src="images/recommendation/New Delhi.jpg" alt="">
         </div>
         <div class="content">
            <h3>Delhi Kutubminar Tour Packages</h3>
            <p>Enjoy the Emirates with unforgettable fun with our china top selling packages!</p>
            <h2>BDT 3,900</h2>
            <a href="book.php" class="btn">book now</a>
         </div>
